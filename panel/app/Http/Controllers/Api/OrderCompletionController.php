    ...
    private function summaryLabels(string $language): array
    {
        $all = [
            'de' => [
                ...
                'owner' => 'Eigentümer', 'management' => 'Bewirtschaftung', 'recipient' => 'Rechnungsempfänger',
            ...
            'it' => [
                ...
                'object' => 'Oggetto', 'property' => 'Immobile', 'address' => 'Indirizzo', 'zip_city' => 'CAP / Città',
                ...
                'position' => 'Voce', 'unit' => 'Unità', 'quantity' => 'Quantità', 'price' => 'Prezzo',
            ...
            'fr' => [
                'title' => 'Données de facturation', 'order' => 'Commande', 'generated' => 'créé le',
                'object' => 'Objet', 'property' => 'Bien', 'address' => 'Adresse', 'zip_city' => 'NPA / Localité',
                'owner' => 'Propriétaire', 'management' => 'Gérance', 'recipient' => 'Destinataire de la facture',
                'company' => 'Entreprise', 'name' => 'Nom', 'send_to' => 'Envoyer la facture à',
                'by_email' => 'par e-mail', 'by_post' => 'par courrier', 'services' => 'Prestations fournies',
                'position' => 'Poste', 'unit' => 'Unité', 'quantity' => 'Quantité', 'price' => 'Prix',
                'amount' => 'Montant', 'total' => 'Total', 'no_items' => 'Aucun poste enregistré.',
                'none' => 'Aucune donnée disponible.', 'your_quote_number' => "Votre numéro d'offre",
            ],
        ];
