...
class PropertyController extends Controller
{
    ...
    public function pdf(Request $request, Property $property)
    {
        ...
        $pdf = Pdf::loadView('pdf.property', [
            ...
            'usageLabel' => $this->getPropertyUsageLabel($property->usage, $language),
            'objectCards' => $this->getPropertyPdfCards($property),
            'pdfLanguage' => $language,
            'labels' => $this->getPropertyPdfLabels($language),
    ...
    private function getPropertyUsageLabel(?string $usage, string $language = 'de'): string
    {
        $labels = [
            'de' => [
                'residential' => 'Wohnen',
        ...
        return ($labels[$language][$usage] ?? $usage) ?: '-';
    }

    private function getPropertyPdfLabels(string $language): array
    {
        $labels = [
            'de' => [
                'sheet_eyebrow' => 'Vergo Liegenschaftsblatt',
                'property_information' => 'Liegenschaftsinformationen',
                'li_number' => 'LI-Nummer',
                ...
                'zip_city' => 'PLZ / Ort',
                'properties' => 'Objekte',
                'address_zip_city' => 'Adresse, PLZ und Ort',
                'property_address' => 'Objektadresse',
                'zip' => 'PLZ',
                'city' => 'Ort',
                'generated_by_vergo' => 'Automatisch generiert durch Vergo',
            ],
            'en' => [
                'sheet_eyebrow' => 'Vergo Property Sheet',
                ...
                'address_zip_city' => 'Address, ZIP Code and City',
                'property_address' => 'Property Address',
                'zip' => 'ZIP',
                'city' => 'City',
                'generated_by_vergo' => 'Automatically generated by Vergo',
            ],
            'fr' => [
                'sheet_eyebrow' => 'Fiche immobilière Vergo',
                'property_information' => 'Informations sur le bien immobilier',
                'li_number' => 'Numéro LI',
                'description' => 'DÉSIGNATION',
                'use' => 'AFFECTATION',
                'management' => 'GESTION',
                'owner' => 'PROPRIÉTAIRE',
                'zip_city' => 'CODE POSTAL / VILLE',
                'properties' => 'BIENS',
                'address_zip_city' => 'Adresse, code postal et ville',
                'property_address' => 'Adresse du bien',
                'zip' => 'Code postal',
                'city' => 'Ville',
                'generated_by_vergo' => 'Générée automatiquement par Vergo',
            ],
            'it' => [
                'sheet_eyebrow' => 'Scheda immobile Vergo',
                'property_information' => "Informazioni sull'immobile",
                'li_number' => 'Numero LI',
                'description' => 'DENOMINAZIONE',
                'use' => "DESTINAZIONE D'USO",
                'management' => 'GESTIONE',
                'owner' => 'PROPRIETARIO',
                'zip_city' => 'CAP / CITTÀ',
                'properties' => 'IMMOBILI',
                'address_zip_city' => 'Indirizzo, CAP e città',
                'property_address' => "Indirizzo dell'immobile",
                'zip' => 'CAP',
                'city' => 'Città',
                'generated_by_vergo' => 'Generato automaticamente da Vergo',
            ],
        ];
