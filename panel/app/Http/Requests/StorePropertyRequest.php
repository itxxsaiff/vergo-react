...
class StorePropertyRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'apartment_count.integer' => 'Apartment count must be a whole number.',
            'apartment_count.min' => 'Apartment count cannot be negative.',
            'commercial_area.numeric' => 'Commercial area must be a valid number.',
