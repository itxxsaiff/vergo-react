...
<head>
    ...
    <style>
        * { font-family: DejaVu Sans, sans-serif; }
        ...
        .head { border-bottom: 3px solid #9f6d54; padding-bottom: 12px; margin-bottom: 18px; }
        .head img { height: 36px; }
        .head h1 { margin: 10px 0 2px; font-size: 18px; color: #9f6d54; }
        .head .meta { color: #6b7280; font-size: 10px; }
        h2 { font-size: 13px; margin: 20px 0 6px; color: #9f6d54; }
        h2 .count { color: #6b7280; font-size: 10px; font-weight: normal; }
        table.jobs { width: 100%; border-collapse: collapse; }
        table.jobs th { background: #f7f0ec; text-align: left; padding: 6px 8px; border: 1px solid #eaded7; font-size: 10px; }
        table.jobs td { padding: 6px 8px; border: 1px solid #eee3dc; }
        table.jobs td.r, table.jobs th.r { text-align: right; }
        .subtotal { text-align: right; font-weight: bold; margin-top: 5px; }
        .grand { margin-top: 22px; padding-top: 10px; border-top: 2px solid #9f6d54; text-align: right; font-size: 13px; font-weight: bold; }
